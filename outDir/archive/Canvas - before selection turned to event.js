...
export class Canvas {
    ...
    applyEvents(events) {
        ...
        this.draw();
        document.getElementById('textField').value = this.eventLogString;
        return this;
    }
        ...
        // Control held without Alt
            ...
            if (selectedArray.length !== 0) {
                ...
                if (index !== -1) {
                    ...
                    this.multiSelectedArray[index][selectedArray.length - 1].marked = true;
                }
                else {
...
//# sourceMappingURL=Canvas%20-%20before%20selection%20turned%20to%20event.js.map